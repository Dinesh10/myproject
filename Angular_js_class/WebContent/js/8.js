...
myapp.directive('ilangoDirective', function(){
	return {
		restrict: 'E',
		template: '<div> This is from ilango\'s directive'
	}

});

myapp.directive('pappuDirective', function(){
	return {
		restrict: 'A',
		template: '<div> This is from pappu\'s directive'
	}
